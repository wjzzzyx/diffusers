...
from segmentors import transform
...
class Block(nn.Module):
    """Transformer block with support of window attention and residual propagation blocks"""
...
class SamPredictor:
    def __init__(
        ...
        self.transform = transform.ResizeLongestSide(sam_model.image_encoder.img_size)
        self.reset_image()
