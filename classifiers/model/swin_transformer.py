...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, input_resolution=None,
...
class PatchMerging(nn.Module):
    ...
    def __init__(self, dim, norm_layer=nn.LayerNorm, input_resolution=None):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(
        ...
        input_resolution=None, fused_window_process=False
    ):
        super().__init__()
        self.dim = dim
        self.depth = depth
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None, img_size=224):
        super().__init__()
...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        x = self.avgpool(x.permute(0, 3, 1, 2))  # B C 1
        x = torch.flatten(x, 1)
        return x
