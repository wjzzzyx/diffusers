...
class AutoencoderKLQwenImage():
    def __init__(
        ...
        self.latents_mean = torch.tensor(latents_mean, dtype=torch.float32)
        self.latents_std = torch.tensor(latents_std, dtype=torch.float32)
    ...
    def tiled_decode(self, z: torch.Tensor, return_dict: bool = True) -> torch.Tensor:
        r"""
