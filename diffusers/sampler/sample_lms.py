...
class LMSSampler():
    ...
    def sample(
        ...
        sample = k_diffusion.sampling.sample_lms(denoiser, xi, sigmas, extra_args=extra_args)
    ...
    def sample_img2img(
        ...
        sample = k_diffusion.sampling.sample_lms(denoiser, xi, sigma_sched, extra_args=extra_args)
